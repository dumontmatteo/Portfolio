...
function toFrench(argument) {
	document.getElementById("title").innerHTML = "Eleve-Ingénieur en Informatique à l'INSA de Lyon, à la recherche d'un stage de 3 mois en developpement front-end.";
	...
	document.getElementById("work-title").innerHTML = "PROJETS";
	document.getElementById("footer-title").innerHTML = "Mes réseaux";
	document.getElementById("cv").href = "files/cv_fr.pdf";
...
function toEnglish(argument) {
	...
	document.getElementById("work-title").innerHTML = "MY WORK";
	document.getElementById("footer-title").innerHTML = "My Socials";
	document.getElementById("cv").href = "files/resume_en.pdf";
